public class FishingRod extends Item {
    ...
    public void fish (Player player){
        ...
        if(!player.getCurrentRoom().getName().equalsIgnoreCase("Island")){
        ...
        if(chance < 0.5){
            ...
            Consumable fish = new Consumable(14,"fish", "Glistening in the sunlight, the fish serve as another health source for the player, however, they will spoil if taken away from the island.", "healing","island",1,5);
